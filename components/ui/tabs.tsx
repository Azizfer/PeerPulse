...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-lg bg-[#fdfcfa] border-2 border-gray-300 p-1 text-gray-600 shadow-sm",
      className
    )}
    {...props}
  />
